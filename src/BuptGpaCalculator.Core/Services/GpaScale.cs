...
/// <summary>Converts official percentage-equivalent scores to grade points.</summary>
public static class GpaScale
{
    ...
    [
        ...
        new(95.5m, 3.96m), new(95.0m, 3.95m, FiveLevelText: "优"), new(94.5m, 3.94m), new(94.0m, 3.93m),
        ...
        new(85.5m, 3.61m), new(85.0m, 3.58m, FiveLevelText: "良"), new(84.5m, 3.55m), new(84.0m, 3.52m),
        new(83.5m, 3.49m), new(83.0m, 3.46m), new(82.5m, 3.43m), new(82.0m, 3.39m),
        new(81.5m, 3.36m), new(81.0m, 3.32m), new(80.5m, 3.29m), new(80.0m, 3.25m, TwoLevelText: "通过"),
        ...
        new(75.5m, 2.87m), new(75.0m, 2.83m, FiveLevelText: "中"), new(74.5m, 2.78m), new(74.0m, 2.73m),
        new(73.5m, 2.68m), new(73.0m, 2.63m), new(72.5m, 2.58m), new(72.0m, 2.53m), new(71.5m, 2.48m),
        ...
        new(65.0m, 1.70m, FiveLevelText: "及格"), new(64.5m, 1.64m), new(64.0m, 1.57m), new(63.5m, 1.50m),
        new(63.0m, 1.43m), new(62.5m, 1.36m), new(62.0m, 1.29m), new(61.5m, 1.22m),
        new(61.0m, 1.15m), new(60.5m, 1.07m), new(60.0m, 1.00m),
        new(0.0m, 0.00m, "小于 60.0", "不及格", "不通过"),
    ];
    ...
    /// <summary>Gets the grade point for a percentage-equivalent score.</summary>
    /// <param name="score">The score from 0 through 100.</param>
    /// <returns>The corresponding grade point.</returns>
    public static decimal GetGradePoint(decimal score)
    {
        if (score is < 0m or > 100m)
        {
            throw new ArgumentOutOfRangeException(nameof(score), "成绩必须为 0 至 100。");
        }

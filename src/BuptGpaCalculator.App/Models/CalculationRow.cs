...
public sealed class CalculationRow(CourseContribution contribution)
{
    ...
    /// <summary>Gets the course score shown to users.</summary>
    public string Score { get; } = contribution.Course.ScoreDisplayText;

    /// <summary>Gets the course credit.</summary>
    public string Credit { get; } = contribution.Course.Credit.ToString("0.0", CultureInfo.InvariantCulture);
    ...
    public string GpaWeight { get; } = contribution.GpaWeight.ToString("0.0000", CultureInfo.InvariantCulture);

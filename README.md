...
BUPT GPA Calculator 是一个面向北京邮电大学学生的本地 Windows 桌面 GPA 计算器。它使用单个 SQLite 成绩档案保存多个学生的数据，支持手动录入、从教务系统成绩表复制导入、按全部/学年/学期统计，以及完整展示 GPA 计算规则。

> 项目处于 v0.1.0 发布前测试阶段，正式发布前仍可能调整界面与细节。
...
- 计算 GA、GPA、总学分和课程数，支持全部、学年或单学期统计；
